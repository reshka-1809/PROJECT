...
btn9=Button(f13,text='Х^n',font='Arial 14')
btn9.pack(pady=5)
btn9.bind('<Button-1>',kvadratn)

btn10=Button(f14,text='Корень n',font='Arial 14')
btn10.pack(pady=5)
...
f9.grid(row=1,column=2)
f10.grid(row=3,column=0)
f11.grid(row=3,column=1)
f12.grid(row=2,column=2)
f13.grid(row=4,column=0)
f14.grid(row=3,column=2)
